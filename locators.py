...
class Locators:
    #Кнопка "Войти"
    ENTER_ACCOUNT_BUTTON = (By.XPATH, ".//section[@class = 'BurgerConstructor_basket__29Cd7 mt-25 ']/div/button[text() = 'Войти в аккаунт']")
    ...
    #Поле ввода имени
    NAME_INPUT_FIELD = (By.XPATH, ".//fieldset//label[text()='Имя']/../input")
    #Поле ввода емейла
    EMAIL_INPUT_FIELD = (By.XPATH, ".//fieldset//label[text()='Email']/../input")
    #Поле ввода пароля
    PASSWORD_INPUT_FIELD = (By.XPATH, ".//fieldset//label[text()='Пароль']/../input")
    ...
    #Кнопка "Войти"
    ENTER_BUTTON = (By.CSS_SELECTOR, "button[class='button_button__33qZ0 button_button_type_primary__1O7Bx button_button_size_medium__3zxIa']")
    ...
    ACCOUNT_PAGE_HEADER = (By.CSS_SELECTOR,"a[class='Account_link__2ETsJ text text_type_main-medium text_color_inactive Account_link_active__2opc9']")
    ...
    #Таба "Начинки"
    NACHNKI_TAB = (By.XPATH, ".//main/section[@class='BurgerIngredients_ingredients__1N8v2']//span[text()='Начинки']/..")
